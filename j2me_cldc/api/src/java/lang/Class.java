...
//     * <p>
//     * Note unlike the J2SE version of this class the parameter must
//     * start with a "/" i.e. "/foobar.data". The alternate form where
//     * the package name is prepended is not supported.
//     *
//     * @param name  name of the desired resource
//     * @return      a <code>java.io.InputStream</code> object.
//     * @since JDK1.1
...
//        if(!name.startsWith("/")) {
//            throw new RuntimeException("Unsupported name format");
//        }
//        byte[] buf = getResourceAsStream0(name);
//        return new java.io.ByteArrayInputStream(buf);
//    }
//    private native static byte[] getResourceAsStream0(String s);
    ...
    public java.io.InputStream getResourceAsStream(String name) {
        ...
        } catch(javax.microedition.io.ConnectionNotFoundException x) {
            return null;
