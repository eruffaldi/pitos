 ...
 * SUBSYSTEM: Profiling
 * FILE:      log.h
 * OVERVIEW:  An object with methods for recording run-time information
...
*=======================================================================*/
    ...
    void (*enterMethod) (const char *type,
...
*=======================================================================*/
    ...
    void (*exitMethod) (const char *className, const char *methodName);
...
*                find a handler for this excpetion.
* INTERFACE:
...
*=======================================================================*/
    ...
    void (*uncaughtException)(INSTANCE exception);

};

typedef struct KVMLogInterface_ *KVMLogInterface;

extern KVMLogInterface Log;
