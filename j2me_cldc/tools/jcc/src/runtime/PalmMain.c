...
#define NUMBER_OF_RESOURCES \
    (11 + NUMBER_OF_METHODTABLE_RESOURCES + NUMBER_OF_CODE_RESOURCES)
...
struct ROMTableOfContentsType ROMTableOfContents = { 
    ...
    { 
	(CLASS)&java_lang_Object_Classblock,
	(CLASS)&java_lang_Class_Classblock,
	(CLASS)&java_lang_String_Classblock,
	(CLASS)&java_lang_Thread_Classblock,
	(CLASS)&java_lang_System_Classblock,
	(CLASS)&java_lang_Throwable_Classblock,
	(CLASS)&manufacturedArrayOfChar_Classblock
    },
    { 
...
static void updateMethodTable(METHODTABLE methodTable) 
{
	...
	UPDATE(method->localCount); 
	UPDATE(method->maxStack); 
	UPDATE(method->mayThrow); 
...
checkThatCompilerHasntReorderedData(void) 
{
	...
	&  checkLocation(&StringHashLinksInternal, StringResource, 
			 "String hash links")
	...
	&  checkLocation(&java_util_Date_Classblock, ClassDefsResource, 
			 "Class Information")
	&  checkLocation(&java_lang_Object_Classblock, ClassDefsResource, 
			 "Class Information")
