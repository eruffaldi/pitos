/* 
 *	MethodInfo.java	1.29	99/06/25 SMI
 *
...
class MethodInfo extends ClassMemberInfo implements Const
{
	...
	for( int i = 0; i < ncode; /*nothing*/){
	    ...
	    case opc_agetfield_quick_w: // EJVM
	    case opc_aputfield_quick_w: // EJVM
		wide[nwide++] = i;
		i += opcLengths[opcode];
		break;
	    default: 
	...
	for (int offset = start; offset < end; ) {
	    ...
	    case opc_agetstatic_checkinit_quick:
	    case opc_aputstatic_checkinit_quick:
	    case opc_getstatic_checkinit_quick: // EVM
	    case opc_getstatic2_checkinit_quick: // EVM
	    case opc_putstatic_checkinit_quick: // EVM
	    case opc_putstatic2_checkinit_quick:  // EVM
	    case opc_invokenonvirtual_quick:
	    case opc_invokesuper_quick:
	    case opc_invokestatic_quick:
	    case opc_invokestatic_checkinit_quick: // EVM
	    case opc_new_quick:
	    case opc_new_checkinit_quick: // EVM
	    case opc_checkcast_quick:
	    case opc_instanceof_quick:
	    case opc_invokevirtual_quick_w:
	    case opc_getfield_quick_w:
	    ...
	    case opc_agetfield_quick:	// EVM
	    case opc_aputfield_quick:	// EVM
		output.print(" #" + at(codeBytes, offset+1));
		offset += 3;
		break;
    ...
    public void relocateAndPackCode (ConstantObject co[]) {
	    ...
	    opcode = (int) code[pc]&0xFF;
	      ...
	      case opc_getstatic2_quick:
              ...
              case opc_putstatic_quick:
	      case opc_putstatic2_quick: 
	      case opc_agetstatic_checkinit_quick: // EVM
	      case opc_getstatic_checkinit_quick: // EVM
	      case opc_getstatic2_checkinit_quick: // EVM
              case opc_aputstatic_checkinit_quick: // EVM
              case opc_putstatic_checkinit_quick: // EVM
	      case opc_putstatic2_checkinit_quick:  // EVM
	      case opc_instanceof_quick:
	      case opc_invokestatic_quick:
